        ...
        <div className="loginPage">
            <div className="loginPageLeft">
                ...
                <form className="loginPage__form" onSubmit={handleSubmit} noValidate>
                    ...
                    <button className="loginPage__form_button" type="submit">Войти в личный кабинет</button>
                    <p className="loginPage__about">Finspot - финансовая онлайн-платформа</p>

                </form>
            </div>

            <div className="loginPageRight">
                <img className="loginPagePicture" src={loginPagePicture} alt="Finspot screenshot"/>
            </div>
        </div>
    )
}
